...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"><img
                src="{{ URL::asset('assets/img/brand/milestone.jpg') }}" class="main-logo" alt="logo"></a>
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/avataaars.svg') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">القائمه الرئيسيه</span></a>
            </li>
            @can('الكاشير')
                <li class="side-item side-item-category"><a href="{{ route('cashier') }}"><i
                            class="fa-solid fa-cart-plus fa-xl"></i> الكاشير</a></li>
                </li>
            @endcan
            @can('الخزنه')
                <li class="side-item side-item-category"><a href="{{ route('safe') }}"><i
                            class="fas fa-lock fa-2x"></i></i> الخزنه </a></li>
                </li>
            @endcan
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}"> الفواتير المدفوعه</a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                <li class="side-item side-item-category">قائمة التقارير</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoicesReport')) }}">تقارير الفواتير</a>
                            </li>
                        @endcan

                        @can('تقرير المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'productsReport')) }}">تقارير المنتجات</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('المستخدمين')
                <li class="side-item side-item-category">قائمة المستخدمين</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">كل المستخدمين</a></li>
                        @endcan
            ...
            @can('الاعدادات')
                <li class="side-item side-item-category">قائمة الاعدادات</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">الاقسام والمنتجات</span><i
