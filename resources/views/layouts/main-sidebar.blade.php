        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_unPaid')) }}">الفواتير غير المدفوعه</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}">الفواتير المدفوعه جزئيا</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail')) }}">كل المستخدمين</a></li>
