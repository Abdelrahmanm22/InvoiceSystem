            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('MarkAsRead_all')}}">Mark All Read</a></span>
                            </div>
                            <p id="notifications_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات غير
                                المقروءه {{ auth()->user()->unreadNotifications->count() }}</p>
                        </div>
                        <div id="unreadNotifications" class="main-notification-list Notification-scroll">
                            @foreach (auth()->user()->unreadNotifications as $notification)
                                <a class="d-flex p-3 border-bottom" href="{{ url('MarkAsRead/' . $notification->data['id'].'/'.$notification->id) }}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/avataaars.svg') }}"></a>
                    <div class="dropdown-menu">
